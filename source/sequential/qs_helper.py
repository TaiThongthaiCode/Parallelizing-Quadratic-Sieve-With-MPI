...
def lin_alg_solve(t_matrix, smooth_nums, N):
        # print(t_matrix)
    xlist = [sqrt(sn+N) for sn in smooth_nums]
    # print(smooth_nums)
    # print(xlist)
    ...
    return "Didn't find any nontrivial factors!", "oops"
